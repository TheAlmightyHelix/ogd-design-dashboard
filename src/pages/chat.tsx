...
const markdownComponents: Components = {
  ...
  h2: ({ children, ...props }) => (
    <h2 className="mb-2 mt-4 text-lg font-semibold leading-snug first:mt-0" {...props}>
      {children}
    </h2>
  ),
  h3: ({ children, ...props }) => (
    <h3 className="mb-2 mt-3 text-base font-semibold leading-snug first:mt-0" {...props}>
      {children}
    </h3>
  ),
  ul: ({ children, ...props }) => (
  ...
  table: ({ children, ...props }) => (
    <div className="my-3 overflow-x-auto">
      <table className="w-full border-collapse border border-gray-300 text-sm leading-normal" {...props}>
        {children}
      </table>
    </div>
  ),
  ...
  td: ({ children, ...props }) => (
    <td className="border border-gray-300 px-3 py-2 align-top leading-normal" {...props}>
      {children}
    </td>
  ),
};
